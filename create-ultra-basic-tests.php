<?php
// Test ultra-básico para identificar el problema
echo "=== TEST ULTRA-BÁSICO DE DIAGNÓSTICO ===\n\n";

echo "PROBLEMA:\n";
echo "list-no-auth.php da error 500\n";
echo "Necesitamos identificar el punto exacto de falla\n\n";

echo "CREANDO TESTS PROGRESIVOS...\n\n";
