<?php
/**
 * API para listar informes médicos - Versión de debug
...
try {
    ...
    if ($sessionToken) {
        try {
            ...
            if (!$userData) {
                ...
                // Para debug, continuar sin validación
                $userData = null;
            } else {
    ...
    error_log("Error en list-informes-debug.php: " . $e->getMessage());
    ...
    error_log("Error de base de datos en list-informes-debug.php: " . $e->getMessage());
    http_response_code(500);
    echo json_encode([
        'success' => false,
