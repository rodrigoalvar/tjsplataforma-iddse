<?php
// Test que simula el entorno web exacto
echo "=== TEST ENTORNO WEB SIMULADO ===\n\n";

echo "PROBLEMA:\n\n";

echo "list.php funciona desde CLI pero falla desde el navegador\n";
echo "Esto indica diferencias en el entorno de ejecución\n\n";

echo "CREANDO TEST DE COMPARACIÓN...\n\n";
...
file_put_contents('test-web-environment.php', $webTestScript);

echo "✅ Test de entorno web creado: test-web-environment.php\n";
echo "📋 URL para probar: http://localhost/portal_estudios/test-web-environment.php\n\n";

echo "COMPARACIÓN DE TESTS:\n\n";

echo "1. test-list-specific.php - Test específico de list.php\n";
echo "2. test-web-environment.php - Test de entorno web\n\n";

echo "INSTRUCCIONES:\n\n";

echo "1. Abrir ambos tests en el navegador\n";
echo "2. Comparar los resultados\n";
echo "3. Identificar diferencias entre CLI y web\n";
echo "4. Aplicar correcciones específicas\n\n";

echo "DIAGNÓSTICO ESPERADO:\n\n";

echo "Los tests nos dirán:\n";
echo "- Si las rutas funcionan en entorno web\n";
echo "- Si las funciones se cargan correctamente\n";
echo "- Si hay diferencias entre CLI y web\n";
