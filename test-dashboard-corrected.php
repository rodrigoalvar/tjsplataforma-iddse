<?php
echo "=== PRUEBA DE DASHBOARD CON PERMISOS CORREGIDO ===\n\n";
...
try {
    ...
    $hasPacsQuery = in_array('pacs_query', $permissions) || in_array('all', $permissions);
    
    echo "🔐 Permisos: " . implode(', ', $permissions) . "\n";
    echo "🔍 PACS Query: " . ($hasPacsQuery ? 'SÍ' : 'NO') . "\n";
    echo "📋 Modo: " . ($hasPacsQuery ? 'PACS Query' : 'Estudios Asignados') . "\n\n";
    ...
    foreach ($assignments as $assignment) {
        ...
        $study = [
            ...
            'viewer_url' => 'https://demoportal.tanjousoft.com.ar/visorweb/studies/' . $studyId . '/viewer',
            'status' => 'assigned',
        ...
        echo "   • Viewer URL: {$study['viewer_url']}\n";
        echo "   • Orthanc ID: {$study['orthanc_study_id']}\n\n";
    }
    ...
    echo "1. ✅ CARGA DE ANTECEDENTES:\n";
    echo "   • Se llama a loadAntecedentsStatus() después de cargar estudios\n";
    echo "   • Usa la misma API que estudios-manager (study_antecedents.php)\n";
    echo "   • Actualiza la información de antecedentes en cada estudio\n\n";
    
    echo "2. ✅ BOTONES DE ACCIONES:\n";
    echo "   • Botón Ver: disponible si tiene viewer_url válido\n";
    echo "   • Botón Descargar: disponible si tiene orthanc_study_id válido\n";
    echo "   • Botón Antecedentes: siempre disponible con contador\n";
    echo "   • Botón Informe: siempre disponible\n\n";
    
    echo "3. ✅ COLUMNA DE ANTECEDENTES:\n";
    echo "   • Muestra contador de antecedentes en la tabla\n";
    echo "   • Se actualiza después de cargar antecedentes\n";
    echo "   • Usa la misma estructura que estudios-manager\n\n";
    
    echo "4. ✅ DATOS REALISTAS:\n";
    ...
    echo "   El dashboard ahora debería funcionar correctamente.\n";
