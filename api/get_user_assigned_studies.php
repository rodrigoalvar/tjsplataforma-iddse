 ...
 * Devuelve estudios con información completa incluyendo antecedentes
 */
...
try {
    ...
    $query = "
        SELECT 
            ...
            -- Información del estudio desde la tabla de estudios (si existe)
            e.patient_name,
            e.patient_id,
            e.study_date,
            e.study_time,
        ...
        LEFT JOIN estudios e ON sa.study_id = e.id
