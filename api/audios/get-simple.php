<?php
/**
 * API simplificado para obtener audios de un informe
 */
...
try {
    // Validar sesión - Priorizar cookies
    $sessionToken = null;
    ...
    error_log("Error en audios/get.php: " . $e->getMessage());
    http_response_code(400);
    echo json_encode([
        'success' => false,
        'message' => $e->getMessage(),
        'error_code' => 'GET_AUDIOS_ERROR',
        'debug' => [
            'file' => __FILE__,
            'line' => $e->getLine()
        ]
    ...
    error_log("Error de base de datos en audios/get.php: " . $e->getMessage());
