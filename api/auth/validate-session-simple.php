        ...
        if (empty($permissions)) {
            switch ($user_data['nivel']) {
                case 'root':
                    ...
                    break;
                case 'admin':
                    $permissions = ['dashboard', 'estudios', 'pacs_query', 'informes', 'gestionInformes', 'informes_recibidos', 'informes_carpeta', 'adjuntar_informe_estudio', 'usuarios', 'plantillas', 'visor', 'pacs_manager'];
                    break;
                case 'user':
